...
#initial_teff = 5500.0; initial_logg = 0.7; initial_MH = -1.56
#initial_teff = 7458.0; initial_logg = 0.5; initial_MH = -0.63
#initial_teff = 4900.0; initial_logg = 0.0; initial_MH = -1.5 #MACHO47
#initial_teff = 8250.0; initial_logg = 1.0; initial_MH = -1.18 #J005252
initial_teff = 6250.0; initial_logg = 0.5; initial_MH = -1.34 #J004441
initial_vmic = 3.5; initial_R = 80000.
...
def ListCreation():
    ...
    #teff = 7458; met = -0.63; logg = 0.5; vmic=3.0 #J003643
    #teff = 4900.0; logg = 0.0; met = -1.5; vmic=3.0 #MACHO47
    #teff = 8250.0; logg = 1.0; met = -1.18; vmic=2.0 #J005252
    teff = 6250.0; logg = 0.5; met = -1.34; vmic=3.5 #J004441

    #teff = 6000; met = -1.57; logg = 0.20; vmic=4.0 
    ...
    solar_abundances['Abund'][81] += 2 #Pb
    #solar_abundances['Abund'][6] += 1.5 #N
    solar_abundances['Abund'][7] += 1 #O
...
######--- Find linemasks -----------------------------------------------------
    ...
    #                        max_atomic_wave_diff = 0.01, \
    #                        telluric_linelist=None, \
    #                        vel_telluric=None, \
    #                        minimum_depth=0.01, maximum_depth=0.5, \
    ...
    #bad_mask = np.logical_or(bad_mask, ~line_regions['molecule'])
